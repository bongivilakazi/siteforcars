 ...
 * @returns {Number} Last zero-d index at which the item is found, or -1.
 */
 ...
 * @param {Number} [pos=0] Zero-d index at which to start the search.
 ...
 *     <li>The zero-d index of the match within the total search string.
 ...
 * @requires XRegExp, XRegExp Unicode 
 */
(function (XRegExp) {
    "use strict";

    if (!XRegExp.addUnicodePackage) {
        throw new ReferenceError("Unicode  must be loaded before Unicode Categories");
    }

    XRegExp.install("extensibility");

    XRegExp.addUnicodePackage({
        //L: "", // Included in the Unicode  addon
        ...
        //L: "Letter", // Included in the Unicode  addon
        Ll: "Lowercase_Letter",
        Lu: "Uppercase_Letter",
        Lt: "Titlecase_Letter",
        Lm: "Modifier_Letter",
...
(function (XRegExp) {
    ...
    if (!XRegExp.addUnicodePackage) {
        throw new ReferenceError("Unicode  must be loaded before Unicode Scripts");
    }
...
(function (XRegExp) {
    ...
    if (!XRegExp.addUnicodePackage) {
        throw new ReferenceError("Unicode  must be loaded before Unicode Blocks");
    }
...
(function (XRegExp) {
    ...
    if (!XRegExp.addUnicodePackage) {
        throw new ReferenceError("Unicode  must be loaded before Unicode Properties");
    }
